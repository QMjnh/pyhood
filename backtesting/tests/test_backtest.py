...
from backtest.compare import sensitivity_report, sensitivity_test
...
class TestMaAtrMeanReversion:
    ...
    def test_import_from_backtest_init(self):
        """Test that ma_atr_mean_reversion is importable from backtest."""
        from backtest import ma_atr_mean_reversion as imported_strategy
...
class TestBenchmarkSpy:
    ...
    def test_benchmark_spy_returns_enriched_results(self):
        ...
        with patch("backtest.compare.yf", create=True) as mock_yf:
    ...
    def test_verdict_beats_both(self):
        ...
        with patch("backtest.compare._fetch_spy_metrics", return_value=(10.0, 0.8)):
...
class TestDonchianBreakout:
    ...
    def test_import_from_backtest_init(self):
        from backtest import donchian_breakout as imported
...
class TestRsi2Connors:
    ...
    def test_import_from_backtest_init(self):
        from backtest import rsi2_connors as imported
        assert callable(imported)
...
class TestMacdCrossover:
    ...
    def test_import_from_backtest_init(self):
        from backtest import macd_crossover as imported
        assert callable(imported)
...
class TestGoldenCross:
    ...
    def test_import_from_backtest_init(self):
        from backtest import golden_cross as imported
        assert callable(imported)
...
class TestKeltnerSqueeze:
    ...
    def test_import_from_backtest_init(self):
        from backtest import keltner_squeeze as imported
        assert callable(imported)
...
class TestVolumeConfirmedBreakout:
    ...
    def test_import_from_backtest_init(self):
        from backtest import volume_confirmed_breakout as imported
        assert callable(imported)
...
class TestBullFlagBreakout:
    ...
    def test_import_from_backtest_init(self):
        from backtest import bull_flag_breakout as imported
        assert callable(imported)
...
class TestSensitivityTest:
    ...
    def test_import_from_backtest_init(self):
        from backtest import sensitivity_report as sr
        from backtest import sensitivity_test as st
        assert callable(st)
        assert callable(sr)
...
class TestRegimeReport:
    ...
    def test_import_from_backtest_init(self):
        from backtest import regime_report as imported
        assert callable(imported)
